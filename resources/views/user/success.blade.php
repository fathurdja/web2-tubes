...
<body class="w-full h-full bg-cover" style="background-image: url('{{ asset('images/backsucceess1.jpg') }}');"  >
    ...
    <!-- ========== MAIN CONTENT ========== -->
    <main id="content"  class="bg-cover" >
        <div class="text-center py-52 px-4 sm:px-6 lg:px-8">
            <h1 class="block text-2xl font-bold text-amber-500 sm:text-4xl">Terima Kasih Atas <span class="text-red-600">Kunjungan anda</span></h1>
            <p class="mt-3 text-lg text-gray-300 dark:text-neutral-400">Silahkan Menikmati dan Selamat datang Kembali
            </p>
            <div class="mt-5 flex flex-col justify-center items-center gap-2 sm:flex-row sm:gap-3">
                <a class="w-full sm:w-auto py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-amber-500 text-gray-800 hover:bg-red-600 disabled:opacity-50 disabled:pointer-events-none"
                    target="parent" href="{{ route('clearOrder') }}">
