    ...
    <form id="form" method="post" action="./addProduct.html"
        ...
        <div class="flex flex-col col-span-3 gap-6 px-8 py-6 bg-white border rounded-lg border-borderPrimary">
            <div class="flex flex-col gap-3">
                ...
                <input type="text" id="product_name" name="product_name" placeholder="Input product name"
            ...
            <div>
                <fieldset class="flex flex-col gap-3">
                    ...
                    <div class="flex gap-1">
                        <div>
                            <input type="radio" name="category" id="food" class="hidden peer" value="food" />
                            <label role="button" for="food" tabindex="0"
                                class="peer-checked:text-white bg-[#D9D9D9] peer-checked:bg-primary px-6 py-2 text-base rounded-s-md">
                                Food
                            </label>
                        </div>
                        <div>
                            <input type="radio" name="category" id="drink" class="hidden peer" value="drink" />
                            <label role="button" for="drink" tabindex="0"
